## **PRJM-0001:** Project Management Testing - Add  

> **Summary:** Verify that the user can add more projects  <br>
...
Scenario 1 
 ...
 | 7 | Click the `create project` button | Verify that it the new project is created |
 
**Post-conditions:**  

 - A new project is created along with existing projects
