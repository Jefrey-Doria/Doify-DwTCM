## **PRJC-0011:** Project Creation Testing - Empty Email Address  
...
Scenario 1 
 ...
 | 7 | Click the `create project` button | Verify that it gives an error when creating a project without a adding an email |
