## **PRJC-0010:** Project Creation Testing - Empty Client Name  

> **Summary:** Verify that Client Name is not empty.  <br>
...
Scenario 1 
 ...
 | 7 | Click the `create project` button | Verify that it gives an error when creating a project without a adding a client name |
 
**Post-conditions:**  

 - Error is shown when Client Name Field is empty
