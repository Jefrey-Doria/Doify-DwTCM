## **TAS-0002:** Task Creation Testing - Edit  

> **Summary:** Verify that Editing the fields feature is working successfully  <br>
...
**Post-conditions:**  
   - A modal is shown
   - The fields in the modal are fields that can be inputed
