## **TAS-0013:** Task Creation Testing - Task Based  

> **Summary:** Verify that Task Based Toggle is displayed successfully.  <br>
...
Scenario 1 
 ...
 | 6 | Click the toggle button in `payment` | Verify that the button works and displays task based or hourly and vice versa |

**Post-conditions:**  
   - Toggle button displays properly indication that it is task based
